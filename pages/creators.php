                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">Satnam Singh</h4>
                   <div class="table-responsive">
                    ...
                    <a href="https://mail.google.com/mail/u/0/?view=cm&fs=1&to=email@domain.com&tf=1" class="btn btn-primary text-center send-mail">Send Mail</a>
                </div>
                </div>
              </div>
            </div>
